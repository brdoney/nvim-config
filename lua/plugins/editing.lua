return {
  ...
  -- Surround with things using keyboard shortcuts
  {
    ...
    init = function()
      ...
      vim.keymap.set('n', '<M-i>', '<Plug>YsurroundiWi', { silent = true, desc = 'Italicize' })
      ...
      vim.keymap.set('v', '<M-i>', '<Plug>VSurroundi', { silent = true, desc = 'Italicize' })
      ...
      vim.keymap.set('n', '<M-b>', '<Plug>YsurroundiWI', { silent = true, desc = 'Bold' })
      ...
      vim.keymap.set('v', '<M-b>', '<Plug>VSurroundI', { silent = true, desc = 'Bold' })
    end
  },
  {
